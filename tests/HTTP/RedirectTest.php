...
class RedirectTest extends TestCase
{
    ...
    {        
        $request = Request::create('/post/1', 'GET');
    ...
    public function testWithInput()
    {
        ...
        $this->assertEquals('John', session()->get('username'));
    }
    ...
    public function testWithInputMultipleValues()
    {
        ...
        $this->assertEquals('John', session()->get('username'));
        $this->assertEquals('john@example.com', session()->get('email'));
    }
    ...
    public function testRedirectBackWithInput()
    {
        ...
        $this->assertEquals('wronguser', $session->get('username'));
    }
